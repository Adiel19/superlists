...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        other_list = List.objects.create()
        Item.objects.create(text = 'item one other list', list = other_list)
        Item.objects.create(text = 'item two other list', list = other_list)
        
        response = self.client.get('/lists/%d/' %(correct_list.id,))

        self.assertContains(response, 'item one')
        self.assertContains(response, 'item two')
        self.assertNotContains(response, 'item one other list')
        self.assertNotContains(response, 'item two other list')
